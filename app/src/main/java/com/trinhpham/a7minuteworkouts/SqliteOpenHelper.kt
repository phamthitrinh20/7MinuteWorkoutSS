...
class SqliteOpenHelper(context : Context, factory: SQLiteDatabase.CursorFactory?) : SQLiteOpenHelper
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        val CRETE_EXERCISE_TABLE = "CREATE TABLE "+ TABLE_HISTORY + "("+COLUMN_ID +" INTEGER PRIMARY KEY,"+COLUMN_COMPLETED_DATE+" TEXT)"
